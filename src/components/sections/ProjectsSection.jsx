...
const projects = [
    {
      ...
      description: "AI-powered platform for exploring academic citations, summaries, and citation strength insights."
    },
    {
      ...
      description: "Web app to manage student project ideas with roles for students and admins, secure login, and approval workflows."
    },
    {
      ...
      description: "A responsive UI clone of Activision's website showcasing sleek design and layout replication."
    },
    {
      ...
      description: "Frontend clone of United Airlines with flight search simulation and adaptive UI."
    },
    {
      title: "Product Shop",
      ...
      description: "E-commerce demo app displaying product listings with responsive UI and API integration."
    },
    {
      ...
      tags: ["React", "Tailwind", "Node.js"],
      description: "Modern clone of Riyadh Season website with attractive sections and event showcase."
    },
    {
      ...
      description: "Job submission form using React hooks with validation, alerts, and clean UI."
    },
    {
      ...
      description: "Simple and responsive Body Mass Index calculator with alerts for results."
    },
    {
      ...
      description: "A clean to-do list app with local storage support and Bootstrap-based design."
    },
    {
      title: "Chat App",
      ...
      description: "Real-time chat application built using React and Node.js with styled components."
    },
    {
      title: "Weather App",
      ...
      tags: ["React", "Tailwind", "Node.js", "API", "MongoDB", "SweetAlert2", "Axios"],
      description: "Weather forecasting app with login support and API integration for real-time data."
    },
  ];
const Projects = () => {
  return (
